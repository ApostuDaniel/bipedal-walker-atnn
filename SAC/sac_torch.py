...
class Agent():
    ...
    def remember(self, state, action, reward, new_state, done):
        self.memory.stor_transition(state, action, reward, new_state, done)
    ...
    def save_models(self):
        ...
        self.value.save_chekpoint()
        self.target_value.save_chekpoint()
        self.critic1.save_chekpoint()
        self.critic2.save_chekpoint()

    def load_models(self):
        print("... saving models ...")
        self.actor.load_chekpoint()
        self.value.load_chekpoint()
        self.target_value.load_chekpoint()
        self.critic1.load_chekpoint()
        self.critic2.load_chekpoint()
